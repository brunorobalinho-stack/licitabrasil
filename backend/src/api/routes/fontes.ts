 ...
 *   get:
 *     tags: [Fontes]
 *     summary: Status de saúde das fontes de dados
 *     security:
 *       - cookieAuth: []
 *     responses:
 *       200:
 *         description: Array de fontes com indicador healthy
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 *               items:
 *                 $ref: '#/components/schemas/FonteDados'
 */
 ...
 *   get:
 *     tags: [Fontes]
 *     summary: Cobertura de dados por esfera e UF
 *     security:
 *       - cookieAuth: []
 *     responses:
 *       200:
 *         description: Contagens por esfera e por estado
 */
