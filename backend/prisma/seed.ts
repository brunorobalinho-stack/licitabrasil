...
async function main() {
  ...
  const fontes = [
    ...
    { nome: 'COMPRASNET_ARP', url: 'https://dadosabertos.compras.gov.br', tipo: 'API', esfera: Esfera.FEDERAL, intervaloMinutos: 360 },
    { nome: 'COMPRASNET_CONTRATOS', url: 'https://dadosabertos.compras.gov.br', tipo: 'API', esfera: Esfera.FEDERAL, intervaloMinutos: 240 },
  ];
